        ...
        programs.noctalia-shell = {
          ...
          settings = {
            ...
            bar = {
              autoHideDelay = 500;
              autoShowDelay = 150;
              # backgroundOpacity managed by stylix opacity.desktop
              barType = "simple";
              capsuleColorKey = "none";
              # capsuleOpacity managed by stylix opacity.desktop
              contentPadding = 2;
              density = "default";
            ...
            ui = {
              ...
              # fontDefault/fontFixed managed by stylix fonts
              fontDefaultScale = 1;
              fontFixedScale = 1;
              # panelBackgroundOpacity managed by stylix opacity.desktop
